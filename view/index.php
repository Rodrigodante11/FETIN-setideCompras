	...
	<div class="container" id="destaque-produtos-container">
		...
		<div id="destaque-produtos">
			...
			<div class="item " ng-repeat="produto in produtos">
				...
				<div class="col-sm-6 col-descricao center">
					
					<h2>{{produto.nome_prod_longo}}</h2>
					<div class="box-valor">
						<div class="text-noboleto text-arial-cinza"></div>
						...
						<div class="text-parcelas text-arial-cinza">ou em até {{produto.parcelas}}x de R$ {{produto.parcela}} no cartão</div>
						<div class="text-total text-arial-cinza">total a Vista R$ {{produto.total}}</div>	
					</div>
