...
<section  ng-controller="cart-controller">
	...
	<div class="container">
		...
		<a href="pdf">
        <button type="button" class="btn btn-azul pull-right" onclick="funcao1()" style="margin-top:10px">Comprar</button>

        </a>
        <a href="index.php">
		     <button type="button" class="btn btn-preto pull-right" style="margin-top:10px">Comprar Mais</button>
	     </a>
