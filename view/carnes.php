...
<section ng-controller="destaque-controller">
	...
	<div id="mais-buscados2" class="container">
			...
			<div class="col-md-3" ng-repeat="produto in buscados">
				<div class="box-produto-info">
					...
					<a href="produto-{{produto.id_prod}}">
						...
						<div class="estrelas" data-score="4.5"></div> <!--{{produto.media}}-->
						<div class="text-qtd-reviews text-arial-cinza">(12)</div><!--{{produto.total_reviews}}-->
