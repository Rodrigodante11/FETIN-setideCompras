			...
			<div class="col-md-3" ng-repeat="produto in buscados">
				<div class="box-produto-info">
					<a href="produto-{{produto.id_prod}}">
						...
						<div class="estrelas" data-score="2.5"></div> <!--{{produto.media}}-->
						<div class="text-qtd-reviews text-arial-cinza">(4)</div>
						<div class="text-valor text-roxo"><strike> de R$ {{produto.preco}}</strike></div>
						<div class="text-parcelado text-arial-cinza">Por  R$ {{produto.total}} só Hoje</div>
					</a>
				</div>
